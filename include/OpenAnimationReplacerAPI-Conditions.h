...
namespace OAR_API::Conditions {
    ...
    class IConditionsInterface2 {
        public:
            ...
            [[nodiscard]] virtual APIResult AddCustomCondition(SKSE::PluginHandle a_myPluginHandle, const char* a_myPluginName,
                                                               REL::Version a_myPluginVersion, const char* a_conditionName,
                                                               ::Conditions::ConditionFactory a_conditionFactory) noexcept = 0;
            ...
            /// <returns>The condition component factory.</returns>
            [[nodiscard]] virtual ::Conditions::ConditionComponentFactory GetConditionComponentFactory(
                ::Conditions::ConditionComponentType a_componentType) noexcept = 0;
    };

    using IConditionsInterface = IConditionsInterface2;

    using _RequestPluginAPI_Conditions = IConditionsInterface* (*) (InterfaceVersion a_interfaceVersion, const char* a_pluginName,
                                                                    REL::Version a_pluginVersion);
