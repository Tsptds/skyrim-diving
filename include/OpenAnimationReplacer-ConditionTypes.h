...
namespace Conditions {
    ...
    using ConditionComponentFactory = IConditionComponent* (*) (const ICondition* a_parentCondition, const char* a_name,
    ...
    enum class ConditionType : uint8_t { kNormal, kCustom, kPreset };
    ...
    enum class ActorValueType : int { kActorValue, kBase, kMax, kPercentage };

    enum class GraphVariableType : int { kFloat, kInt, kBool };

    enum class StateDataScope : int { kNone = 0, kLocal = 1 << 0, kSubMod = 1 << 1, kReplacerMod = 1 << 2, kReference = 1 << 3 };
    inline StateDataScope operator|(StateDataScope a, StateDataScope b) {
        return static_cast<StateDataScope>(static_cast<int>(a) | static_cast<int>(b));
    }
    inline StateDataScope operator&(StateDataScope a, StateDataScope b) {
        return static_cast<StateDataScope>(static_cast<int>(a) & static_cast<int>(b));
    }
    ...
    inline StateDataScope operator~(StateDataScope a) {
        return static_cast<StateDataScope>(~static_cast<int>(a));
    }
    inline StateDataScope& operator|=(StateDataScope& a, StateDataScope b) {
        return a = a | b;
    }
    ...
    class ICondition {
        public:
            ...
            [[nodiscard]] virtual bool Evaluate(RE::TESObjectREFR* a_refr, RE::hkbClipGenerator* a_clipGenerator,
                                                void* a_parentSubMod) const = 0;
            ...
            virtual void Serialize(void* a_value, void* a_allocator,
                                   ICondition* a_outerCustomCondition =
                                       nullptr) = 0;  // rapidjson::Value* a_value, rapidjson::Document::AllocatorType* a_allocator
            ...
            virtual IConditionComponent* AddComponent(ConditionComponentFactory a_factory, const char* a_name,
                                                      const char* a_description = "") = 0;
            ...
            [[nodiscard]] virtual RE::TESObjectREFR* GetRefrToEvaluate(RE::TESObjectREFR* a_refr) const {
                return a_refr;
            }

            [[nodiscard]] class ConditionSet* GetParentConditionSet() const {
                return _parentConditionSet;
            }
            void SetParentConditionSet(ConditionSet* a_conditionSet) {
                _parentConditionSet = a_conditionSet;
            }
    ...
    class IConditionComponent {
        public:
            IConditionComponent(const ICondition* a_parentCondition, const char* a_name, const char* a_description = "")
                : _parentCondition(a_parentCondition), _name(a_name), _description(a_description) {}
            ...
            virtual void SerializeComponent(
                void* a_value, void* a_allocator) = 0;  // rapidjson::Value* a_value, rapidjson::Document::AllocatorType* a_allocator
            ...
            [[nodiscard]] virtual RE::BSString GetArgument() const = 0;
            [[nodiscard]] virtual RE::BSString GetName() const {
                return _name.data();
            }
    ...
    class IStateData {
        public:
            ...
            virtual bool Update([[maybe_unused]] float a_deltaTime) {
                return false;
            }
            virtual void OnLoopOrEcho([[maybe_unused]] RE::hkbClipGenerator* a_clipGenerator, [[maybe_unused]] bool a_bIsEcho) {}
            virtual bool ShouldResetOnLoopOrEcho([[maybe_unused]] RE::hkbClipGenerator* a_clipGenerator,
                                                 [[maybe_unused]] bool a_bIsEcho) const {
                return false;
            }
    };
    ...
    class IMultiConditionComponent : public IConditionComponent {
        public:
            ...
            [[nodiscard]] ConditionComponentType GetType() const override {
                return CONDITION_COMPONENT_TYPE;
            }
            [[nodiscard]] RE::BSString GetDefaultDescription() const override {
                return DEFAULT_DESCRIPTION;
            }

            [[nodiscard]] virtual ConditionSet* GetConditions() const = 0;
            [[nodiscard]] virtual bool EvaluateAll(RE::TESObjectREFR* a_refr, RE::hkbClipGenerator* a_clipGenerator,
                                                   void* a_parentSubMod) const = 0;
            [[nodiscard]] virtual bool EvaluateAny(RE::TESObjectREFR* a_refr, RE::hkbClipGenerator* a_clipGenerator,
                                                   void* a_parentSubMod) const = 0;
            virtual RE::BSVisit::BSVisitControl ForEachCondition(
                const std::function<RE::BSVisit::BSVisitControl(std::unique_ptr<ICondition>&)>& a_func) const = 0;
    ...
    class INumericConditionComponent : public IConditionComponent {
        public:
            ...
            inline static constexpr auto DEFAULT_DESCRIPTION =
                "A numeric value - a static value, a reference to a global variable, an Actor Value, or a behavior graph variable."sv;
    ...
    class IKeywordConditionComponent : public IConditionComponent {
        public:
            ...
            inline static constexpr auto DEFAULT_DESCRIPTION =
                "A keyword value - a reference to a BGSKeyword form, or a literal EditorID of the keyword."sv;
    ...
    class IConditionStateComponent : public IConditionComponent {
        public:
            ...
            inline static constexpr auto DEFAULT_DESCRIPTION =
                "This condition stores state data. In some cases you can select whether that data is unique to a single animation clip, shared between animation clips in the same submod, or shared with other instances of the same condition class across a specified scope."sv;
            ...
            [[nodiscard]] virtual IStateData* GetStateData(RE::TESObjectREFR* a_refr, RE::hkbClipGenerator* a_clipGenerator,
                                                           void* a_parentSubMod) const = 0;
            [[nodiscard]] virtual IStateData* AddStateData(IStateData* a_stateData, RE::TESObjectREFR* a_refr,
                                                           RE::hkbClipGenerator* a_clipGenerator, void* a_parentSubMod) = 0;
    };
    ...
    class CustomCondition : public ICondition {
        public:
            ...
            void Initialize(void* a_value) override {
                return _wrappedCondition->Initialize(a_value);
            }
            void Serialize(void* a_value, void* a_allocator, [[maybe_unused]] ICondition* a_outerCondition) override {
                _wrappedCondition->Serialize(a_value, a_allocator, this);
            }

            void PreInitialize() override {
                _wrappedCondition->PostInitialize();
            }
            ...
            [[nodiscard]] RE::BSString GetRequiredPluginName() const override {
                return SKSE::PluginDeclaration::GetSingleton()->GetName().data();
            }
            [[nodiscard]] RE::BSString GetRequiredPluginAuthor() const override {
                return SKSE::PluginDeclaration::GetSingleton()->GetAuthor().data();
            }

            [[nodiscard]] bool IsDisabled() const override {
                return _wrappedCondition->IsDisabled();
            }
            void SetDisabled(bool a_bDisabled) override {
                _wrappedCondition->SetDisabled(a_bDisabled);
            }
            [[nodiscard]] bool IsNegated() const override {
                return _wrappedCondition->IsNegated();
            }
            void SetNegated(bool a_bNegated) override {
                _wrappedCondition->SetNegated(a_bNegated);
            }

            [[nodiscard]] uint32_t GetNumComponents() const override {
            ...
            IConditionComponent* AddComponent(ConditionComponentFactory a_factory, const char* a_name,
                                              const char* a_description = "") override {
                return _wrappedCondition->AddComponent(a_factory, a_name, a_description);
            }

            [[nodiscard]] ConditionType GetConditionType() const override {
            ...
            IConditionComponent* AddBaseComponent(ConditionComponentType a_componentType, const char* a_name,
                                                  const char* a_description = "");
